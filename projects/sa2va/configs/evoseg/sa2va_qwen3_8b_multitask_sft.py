...
Data mix (Sa2VA-style concat + repeats):
  RefCOCO(x5) + RefCOCO+(x5) + RefCOCOg(x4) + gRefCOCO(x2) + ReasonSeg(x10)
  + MeViS(x4) + RefYTVOS(x4) + Ryvos(x2) + LLaVA-150K(x0.5 anti-forgetting)
...
train_dataset = dict(
    type=ConcatDatasetSa2VA, datasets=[
        ...
        dict(type=Sa2VA03RefVOS, name='MeViS',
             ...
             select_number=1, sampled_frames=5, repeats=4,
        ...
        dict(type=Sa2VA03RefVOS, name='RyvOS',
             ...
             dataset_type='default', select_number=1, sampled_frames=5, repeats=2,
             **sa2va_default_dataset_configs),
        dict(type=LLaVADataset, name='LLaVA150K',
             ...
             skip_pure_text=True, repeats=0.5,
