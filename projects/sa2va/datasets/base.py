...
class Sa2VABaseDataset(Dataset, Sa2VADatasetMixin):
    ...
    def __init__(self,
        ...
        """
        # [EvoSeg] Guard against double-initializing mmengine BaseDataset.
        # RefCocoDataset already calls BaseDataset.__init__ (full_init).
        # Calling it again here resets data_list=[] while _fully_initialized
        # stays True, so full_init short-circuits and the dataset ends up empty.
