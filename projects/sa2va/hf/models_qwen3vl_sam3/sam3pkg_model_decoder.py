...
from .sam3pkg_sam_rope import apply_rotary_enc, apply_rotary_enc_real, compute_axial_cis
from .sam3pkg_sam_transformer import RoPEAttention
from torch import nn, Tensor
from torch.nn.attention import sdpa_kernel, SDPBackend
from torchvision.ops.roi_align import RoIAlign

from .sam3pkg_model_act_ckpt_utils import activation_ckpt_wrapper
from .sam3pkg_model_box_ops import box_cxcywh_to_xyxy
from .sam3pkg_model_model_misc import (
...
def functional_attention(
    ...
    *,
    ...
    if use_fa3:
        raise NotImplementedError('perflib.fa3 op not vendored in the HF release; fill_hole_area must be 0')  # flash_attn_func
