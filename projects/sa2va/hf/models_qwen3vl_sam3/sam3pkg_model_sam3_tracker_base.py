...
from .sam3pkg_model_memory import SimpleMaskEncoder
from .sam3pkg_model_sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames
from .sam3pkg_sam_mask_decoder import MaskDecoder, MLP
from .sam3pkg_sam_prompt_encoder import PromptEncoder
from .sam3pkg_sam_transformer import TwoWayTransformer
...
from .sam3pkg_model_data_misc import BatchedDatapoint
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _compile_all_components(self):
        ...
        from .sam3pkg_perflib_compile import compile_wrapper
